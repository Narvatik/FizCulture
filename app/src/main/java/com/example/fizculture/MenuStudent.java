...
public class MenuStudent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        option.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentSetting1 = new Intent(getActivity(), Setting1_student_intent.class);
        ...
        option2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSetting1 = new Intent(getActivity(), Setting2_student_intent.class);
                startActivity(intentSetting1);
            }
        });
